...
@section('content')
    ...
    <div class="row justify-content-center">
                ...
                <center>
            <h3>    <div class="card-header">{{ __(' Księgi Handlowe - deklaracje zgłoszone do realizacji') }} </div> </h3>
                 </center>
  ...
  <tbody>
    ...
    <tr>
<td class="table-row" data-href="{{action('MonthController@showkh', $projects->czas) }}" >{{ $loop->iteration }}. {{$projects->firm->name}} @if(!empty($projects->firm->number)) ({{$projects->firm->number}}) @endif</td> 
<td class="table-row" data-href="{{action('MonthController@showkh', $projects->czas) }}"> {{$projects->vat}} {{$projects->pit5_cit}} {{$projects->vat_ue}} {{$projects->vat_uea}} {{$projects->vat_ueb}} {{$projects->vat_uec}} {{$projects->vat_27}} {{$projects->akc}} {{$projects->cit_st}} @if(!empty($projects->korekta)) <b>(korekta)</b> @endif</td> 
<td class="table-row" data-href="{{action('MonthController@showkh', $projects->czas) }}">{{$projects->user->name}} {{$projects->user->surname}}</td> 
<td class="table-row" data-href="{{action('MonthController@showkh', $projects->czas) }}">{{$projects->close_date}} {{$projects->close_time}}</td> 
<td class="table-row" data-href="{{action('MonthController@showkh', $projects->czas) }}">@if(!empty($projects->uwagi || $projects->uwagidokorekty))TAK @else NIE  @endif</td> 
...
<td class="table-success table-row" data-href="{{action('MonthController@show', $projects->czas) }}"> {{$projects->vat}} {{$projects->pit5_cit}} {{$projects->vat_ue}} {{$projects->vat_uea}} {{$projects->vat_ueb}} {{$projects->vat_uec}} {{$projects->vat_27}} {{$projects->akc}} {{$projects->cit_st}} @if(!empty($projects->korekta)) <b>(korekta)</b> @endif</td> 
...
<td class="table-success table-row" data-href="{{action('MonthController@show', $projects->czas) }}">@if(!empty($projects->uwagi || $projects->uwagidokorekty))TAK @else NIE  @endif</td> 
