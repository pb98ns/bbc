...
return View('month.list',compact('project2','today','user','firm','task','today2','today3','project4','today4','start_date','end_date','month'));
}
...
->where("months.user_id", "=", $auth_user_id)->where("months.status1", "=", "Potwierdzone")->orderby('close_date',"desc")->orderby('close_time',"desc")->get(); 
    ...
    return View('month.list',compact('today','user','firm','today2','project2','today3','project4','today4','start_date','end_date','month'));
}
public function store(Request $request)
{
    ...
    $month ->vat_27=$request->input('vat_27');
...
public function updatekpir(Request $request, $id)
{
    ...
    $second = $month->przelew;
        $valueprzelew = $second.' '.$today3.' '.$today2.' '.$request->input('przelew').'';
...
return View('month.list8',compact('project2','today','user','firm','task','today2','today3','project4','today4','start_date','end_date','month','suma','project22'));
}
...
return View('month.list10',compact('project2','today','user','firm','task','today2','today3','project4','today4','start_date','end_date','month','suma','project22'));}
