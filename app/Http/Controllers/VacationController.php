...
return View('vacation.list', compact('vacations','today2','today3','vacationscount','vacations_ch','vacationscount_ch','test','chest'));
}
public function index2(){
    ...
    $vacations=Vacation::join('users','vacations.user_id','=','users.id')->where("users.permissions", "!=", "Nieaktywny")->where("vacation_date", "=", $today)->orderBy('users.surname', "asc")->groupBy('user_id')->get(); 
    $vacations_uw=Vacation::join('users','vacations.user_id','=','users.id')->select("vacations.*",DB::raw("sum(`size`) as czas"))->where("users.permissions", "!=", "Nieaktywny")->where("type_vacation", "=", "UW")->whereBetween('vacation_date', [$today2, $today3])->orderBy('users.surname', 'asc')->groupBy('user_id')->distinct('vacation_date')->get(); 
    $vacations_ch=Vacation::join('users','vacations.user_id','=','users.id')->select("vacations.*",DB::raw("sum(`size`) as czas"))->where("users.permissions", "!=", "Nieaktywny")->where("type_vacation", "=", "CH")->whereBetween('vacation_date', [$today2, $today3])->orderBy('users.surname', 'asc')->groupBy('user_id')->get(); 
...
public function searchvacation(Request $request)
{
    ...
    $end_date = $request->input('end_date2');
                ...
                public function searchday(Request $request, UserRepository $userRepo, FirmRepository $firmRepo){
                    ...
                    $vacations=Vacation::join('users','vacations.user_id','=','users.id')->where("vacation_date", "=", $today)->orderBy('users.surname', "asc")->groupBy('vacation_date')->get(); 
                    $vacations_uw=Vacation::join('users','vacations.user_id','=','users.id')->select("vacations.*",DB::raw("sum(`size`) as czas"))->where("type_vacation", "=", "UW")->whereBetween('vacation_date', [$today2, $today3])->groupBy('user_id')->get(); 
                    $vacations_ch=Vacation::join('users','vacations.user_id','=','users.id')->select("vacations.*",DB::raw("sum(`size`) as czas"))->where("type_vacation", "=", "CH")->whereBetween('vacation_date', [$today2, $today3])->groupBy('user_id')->get(); 
                ...
                public function searchperiod(Request $request, UserRepository $userRepo, FirmRepository $firmRepo){
                  ...
                  $vacations=Vacation::join('users','vacations.user_id','=','users.id')->where("users.permissions", "!=", "Nieaktywny")->where("vacation_date", "=", $today)->orderBy('users.surname', "asc")->get(); 
                    $vacations_uw=Vacation::join('users','vacations.user_id','=','users.id')->select("vacations.*",DB::raw("sum(`size`) as czas"))->where("users.permissions", "!=", "Nieaktywny")->where("type_vacation", "=", "UW")->whereBetween('vacation_date', [$start_date, $end_date])->orderBy('surname', 'asc')->groupBy('user_id')->get(); 
                    $vacations_ch=Vacation::join('users','vacations.user_id','=','users.id')->select("vacations.*",DB::raw("sum(`size`) as czas"))->where("users.permissions", "!=", "Nieaktywny")->where("type_vacation", "=", "CH")->whereBetween('vacation_date', [$start_date, $end_date])->orderBy('surname', 'asc')->groupBy('user_id')->get(); 
                ...
                $vacations_count=Vacation::join('users','vacations.user_id','=','users.id')->select("vacations.*",DB::raw("sum(`size`) as czas"))->orderBy('vacation_date', 'desc')->where("user_id", "=", $user_id)->where("type_vacation", "=", "UW")->whereBetween('vacation_date', [$variable6, $variable7])->groupBy('user_id')->get(); 
                ...
                $vacations_count=Vacation::join('users','vacations.user_id','=','users.id')->select("vacations.*",DB::raw("sum(`size`) as czas"))->orderBy('vacation_date', 'desc')->where("user_id", "=", $user_id)->where("type_vacation", "=", "CH")->whereBetween('vacation_date', [$variable6, $variable7])->groupBy('user_id')->get(); 
